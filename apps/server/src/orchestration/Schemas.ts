import {
  ...
  ThreadRemoteAccessSetPayload as ContractsThreadRemoteAccessSetPayloadSchema,
...
export const ThreadRemoteAccessSetPayload = ContractsThreadRemoteAccessSetPayloadSchema;
